...
#sys: controla o comunica con el intérprete de Python.
#platform: para saber en que sistema o hardware se está ejecutando el sistema.
#subprocess: para ejecutar comandos o programas externos desde Pyhton.
